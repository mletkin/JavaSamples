...
import static org.mletkin.samples.console.General.mkButton;
...
import org.mletkin.samples.console.PipedConsole;
...
public class SampleThreadWindow {
    ...
    private JFrame frame = new JFrame("Thread Example with suspend/resme");
